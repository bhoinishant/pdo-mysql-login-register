	...
	<div align="center">
		<div style=" border: solid 1px #006D9C; " align="left">
			...
			<div style="margin: 15px">
				...
				<input type="text" name="confirm fullname" placeholder="confirm fullname" value="<?php if(isset($_POST['confirm fullname'])) echo $_POST['confirm fullname'] ?>" autocomplete="off" class="box"/><br /><br />
					...
					<input type="text" name="confirm username" placeholder="Confirm Username" value="<?php if(isset($_POST['username'])) echo $_POST['username'] ?>" autocomplete="off" class="box"/><br /><br />
					...
					<input type="password" name="confirm password" placeholder="Confirm Password" value="<?php if(isset($_POST['password'])) echo $_POST['password'] ?>" class="box" /><br/><br />
